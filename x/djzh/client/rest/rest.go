...
/*	registerQueryRoutes(cliCtx, r)
	...
	r.HandleFunc(fmt.Sprintf("/djzh/articles/createarticle"), CreateArticleHandler(cliCtx)).Methods("PUT")
	r.HandleFunc(fmt.Sprintf("/djzh/articles/createcomment"), CreateCommentHandler(cliCtx)).Methods("PUT")
